...
public class OntologyEvent {
    ...
    public OntologyEvent withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((((((("OntologyEvent"+" [id=")+ id)+", ontologyRef=")+ ontologyRef)+", method=")+ method)+", methodVersion=")+ methodVersion)+", timestamp=")+ timestamp)+", eco=")+ eco)+", description=")+ description)+", additionalProperties=")+ additionalProperties)+"]");
    }
