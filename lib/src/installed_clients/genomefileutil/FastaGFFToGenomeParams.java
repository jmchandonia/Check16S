...
public class FastaGFFToGenomeParams {
    ...
    public FastaGFFToGenomeParams withTaxonId(java.lang.String taxonId) {
        this.taxonId = taxonId;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((((((((((((((("FastaGFFToGenomeParams"+" [fastaFile=")+ fastaFile)+", gffFile=")+ gffFile)+", genomeName=")+ genomeName)+", workspaceName=")+ workspaceName)+", source=")+ source)+", taxonWsname=")+ taxonWsname)+", taxonId=")+ taxonId)+", release=")+ release)+", geneticCode=")+ geneticCode)+", scientificName=")+ scientificName)+", metadata=")+ metadata)+", generateMissingGenes=")+ generateMissingGenes)+", additionalProperties=")+ additionalProperties)+"]");
    }
