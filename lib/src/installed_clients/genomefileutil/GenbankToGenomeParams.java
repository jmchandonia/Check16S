...
public class GenbankToGenomeParams {
    ...
    public GenbankToGenomeParams withTaxonId(java.lang.String taxonId) {
        this.taxonId = taxonId;
        return this;
    }
    ...
    public GenbankToGenomeParams withScientificName(java.lang.String scientificName) {
        this.scientificName = scientificName;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((((((((((((((((("GenbankToGenomeParams"+" [file=")+ file)+", genomeName=")+ genomeName)+", workspaceName=")+ workspaceName)+", source=")+ source)+", taxonWsname=")+ taxonWsname)+", taxonId=")+ taxonId)+", release=")+ release)+", generateIdsIfNeeded=")+ generateIdsIfNeeded)+", geneticCode=")+ geneticCode)+", scientificName=")+ scientificName)+", metadata=")+ metadata)+", generateMissingGenes=")+ generateMissingGenes)+", useExistingAssembly=")+ useExistingAssembly)+", additionalProperties=")+ additionalProperties)+"]");
    }
