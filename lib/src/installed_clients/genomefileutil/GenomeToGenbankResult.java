...
public class GenomeToGenbankResult {
     ...
     */
    @JsonProperty("genbank_file")
    public void setGenbankFile(GBFile genbankFile) {
        this.genbankFile = genbankFile;
    }

    public GenomeToGenbankResult withGenbankFile(GBFile genbankFile) {
        this.genbankFile = genbankFile;
        return this;
    }
